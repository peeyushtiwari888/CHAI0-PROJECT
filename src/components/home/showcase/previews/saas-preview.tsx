...
export function SaaSPreview() {
  return (
    <div className="flex h-full w-full bg-[#0a0a0a] text-slate-200">
      {/* Sidebar */}
      <div className="w-56 shrink-0 border-r border-slate-800 bg-[#0f0f0f] p-4 flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-slate-400 hover:text-slate-200 hover:bg-slate-800/50">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Header */}
        <header className="h-14 border-b border-slate-800 bg-[#0f0f0f]/80 flex items-center justify-between px-6 shrink-0 backdrop-blur-sm">
          <div className="flex items-center gap-2 w-64 bg-[#1a1a1a] border border-slate-800 rounded-md px-3 py-1.5">
            <Search className="size-4 text-slate-500" />
            <span className="text-sm text-slate-500">Search metrics...</span>
          </div>
          <div className="flex items-center gap-4">
            <Bell className="size-4 text-slate-400" />
            <div className="size-7 rounded-full bg-slate-700 border border-slate-600" />
          </div>
        </header>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-xl border border-slate-800 bg-[#111] p-5">
              <div className="text-sm font-medium text-slate-400">Total Revenue</div>
              <div className="mt-2 text-3xl font-bold text-white">$45,231.89</div>
            ...
            <div className="rounded-xl border border-slate-800 bg-[#111] p-5">
              ...
              <div className="mt-2 text-3xl font-bold text-white">+2,350</div>
              <div className="mt-2 flex items-center text-xs text-emerald-400">
                <ArrowUpRight className="mr-1 size-3" /> +180.1% from last month
              </div>
            </div>
            <div className="rounded-xl border border-slate-800 bg-[#111] p-5">
              <div className="text-sm font-medium text-slate-400">Active Now</div>
              <div className="mt-2 text-3xl font-bold text-white">573</div>
              <div className="mt-2 flex items-center text-xs text-emerald-400">
            ...
            <div className="rounded-xl border border-slate-800 bg-[#111] p-5">
              ...
              <div className="mt-2 text-3xl font-bold text-white">1.2%</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 rounded-xl border border-slate-800 bg-[#111] p-5 flex flex-col">
              <div className="text-base font-medium text-white mb-6">Revenue Over Time</div>
            ...
            <div className="rounded-xl border border-slate-800 bg-[#111] p-5">
              <div className="text-base font-medium text-white mb-4">Recent Sales</div>
